"""
step_impl_generator.py  [FIXED]
================================
Reads AI-generated JSON and writes execution_layer/step_impl/ai_steps.py.

KEY CHANGE: Instead of trying to figure out which steps to include,
we ALWAYS write the full comprehensive set of steps that covers every
possible pattern spec_generator.py can produce.

This guarantees zero ValidationErrors from Gauge.
...
def _generate_ai_steps(url: str, report_id: str, timestamp: str) -> str:
    """
    Returns the full content of ai_steps.py as a string.
    Contains ALL step implementations needed for any spec this tool produces.
    Written as plain string concatenation — no f-strings with {} to avoid
    accidental evaluation of Playwright selector syntax.
    """
    lines = []
...
class StepImplGenerator:
    ...
    def generate(self) -> Path:
        ...
        code = _generate_ai_steps(url, report_id, timestamp)
